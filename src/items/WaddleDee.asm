...
// @ Description
// Shared between Waddle Dee and Waddle Doo
...
// state 0 - main/aerial
dw waddle_dee_aerial_main_              // 0 main
dw waddle_dee_collision_                // 0 collision
...
dw waddle_dee_collision_                //  4 collision / aerial transition
