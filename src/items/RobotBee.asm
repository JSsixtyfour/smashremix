...
constant SPAWN_ITEM(Hazards.robot_bee_stage_setting_)
...
dw 0x00000000                           // 0x10 - ?
robot_bee_item_states:
// state 0 - main/aerial
dw Hazards.robot_bee_main_              // 0x14 - state 0 main
...
dw Hazards.robot_bee_destroy_           // 0x30 - state 0 hurtbox collision w/ hitbox
// state 1 - resting
dw Hazards.robot_bee_main_              // 0x34 - state 1 main
...
dw Hazards.robot_bee_destroy_           // 0x50 - state 1 hurtbox collision w/ hitbox
// state 2 - explosion
...
dw Hazards.robot_bee_destroy_           // 0xF0 - state 2 hurtbox collision w/ hitbox
