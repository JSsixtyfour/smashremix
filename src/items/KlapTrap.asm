...
constant SPAWN_ITEM(Hazards.klaptrap_stage_setting_)
...
dw 0x12300000                           // 0x0C - ? either 0x1B000000 or 0x1C000000 - possible argument
dw 0x00000000                           // 0x10 - ?
klaptrap_item_states:
// state 0 - main/aerial
dw Hazards.klaptrap_main_                       // 0x14 - state 0 main
...
// state 1 - resting
dw Hazards.klaptrap_main_                       // 0x34 - state 1 main
