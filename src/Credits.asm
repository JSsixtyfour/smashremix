...
scope Credits {
    ...
    add_name("mosky2000", "Music Porter - Crescent|Island, Frosty Village,|Windy and Co, Wizpig|Challenge", remix)
    ...
    add_name("TheQuickSlash", "Music Arranger", remix)
    add_name("supa", "", remix)
    ...
    add_name("Sope", " Smashketball, Glacial River,|Congo Falls, Planet|Clancer, Jungle Japes,|Pirate Land, Metallic|Madness, Scuttle Town", remix)
    ...
    add_name("Darkhorse", "Playtesting, Frame Data|Analysis, Great Ideas", remix)
    ...
    add_name("1upShyguy", "Playtester Tourney|Operator", remix)
    add_name("Terra", "", remix)
    add_name("Stew", "", remix)
    add_name("thetaiter", "", remix)
    add_name("LesbianChemicalPlant", "Playtester Tourney|Regular", remix)
    add_name("Bedoop!", "", remix)
    add_name("CMM1215", "Ooooh, that's cute", remix)
    add_name("Djzach", "", remix)
    add_name("Exile", "Playtester Tourney|Regular", remix)
    add_name("FrankBlack22", "", remix)
    add_name("Freean", "", remix)
    add_name("Gibrani", "is typing...", remix)
    add_name("Huntsman", "", remix)
    add_name("Indefa", "", remix)
    add_name("MultiVolt", "", remix)
    add_name("Policombo", "", remix)
    add_name("Raihem/MayRai", "Playtester Tourney|Regular", remix)
    ...
    add_name("MissingNo.", "Playtester Tourney|Regular", remix)
    add_name("Pringles", "Nobody wants to |admit they ate |nine cans of |ravioli.", remix)
    add_name("EG", "Playtester Tourney|Regular", remix)
    ...
    add_name("King Meteor", "Corneria, Flat Zone 2,|Multi-Man Melee 2,|Brinstar Depths", none)
    ...
    add_name("Dave Phaneuf", "Metal Battle, Wendy's|House", none)
    ...
    add_name("erik@vbe.com", "Fight Against Bowser", none)
    ...
    add_name("Joe Cortez", "Vs. Marx, Super Mario|Bros. 2 Overworld,|Super Mario Bros.|2 Boss", none)
    ...
    add_name("thatoneinternetuser", "Grabbag||CALL APOGEE|SAY \dAARDWOLF\d", none)
    add_name("Sebastian Kingsley", "Battle C1", none)

    add_title("Video Team")
    add_name("Fray", "Trailer Editing, Footage|Capturing, Marth Cinematic", remix)
    add_name("Darkhorse", "Trailer Directing, Trailer|Editing, Graphics||hi joe", remix)
    add_name("sope", "Graphics, Cinematic|Animation", remix)
    add_name("Dshaynie", "Cinematic Animation,|Trailer Editing", remix)
    add_name("TheQuickSlash", "Cinematic Animation,|Trailer Editing", remix)
