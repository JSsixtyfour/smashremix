...
scope FGM {
    ...
    add_sound(Wario/sounds/GET_OUT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Wario/sounds/YAHOO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    ...
    add_sound(Wario/sounds/VICTORY_3, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    ...
    add_sound(Wario/sounds/ANNOUNCER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
