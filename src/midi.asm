...
scope MIDI {
    ...
    macro add_instrument(name, volume, pan, priority, trem_type, trem_rate, trem_depth, trem_delay, vib_type, vib_rate, vib_depth, vib_delay) {
        evaluate inst_num(instrument_count)
    ...
    add_instrument(TT Unknown Instrument, 0x7E, 0x3F, 0x05, 0x0, 0x0, 0x0, 0x0, 0x80, 0xF1, 0x64, 0x01)
