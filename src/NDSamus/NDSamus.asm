...
scope NDSamus {
    ...
    Character.edit_action_parameters(NDSAMUS, Action.Walk1,          File.DSAMUS_WALK_1,         DSamus.WALK,                       -1)
    Character.edit_action_parameters(NDSAMUS, Action.Walk2,          File.DSAMUS_WALK_2,         DSamus.WALK,                       -1)
    Character.edit_action_parameters(NDSAMUS, Action.Walk3,          File.DSAMUS_WALK_3,         DSamus.WALK,                       -1)
