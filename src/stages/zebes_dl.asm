...
constant NUM_SPRITE_INFO_ARRAYS(0x03)

// @ Description
// Not sure what the data is at this offset.
constant STAGE_FILE_OFFSET(0x000075E0)
...
// 
Stages.add_sprite_info_array(0x0001, 0x0000, 0x0, 0x01)
// 
...
insert sprite_data, "zebes_dl.bin"
