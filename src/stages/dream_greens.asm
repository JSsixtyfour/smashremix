...
constant NUM_SPRITE_INFO_ARRAYS(0x06)

// @ Description
// Not sure what the data is at this offset.
constant STAGE_FILE_OFFSET(0x00009D88)
...
// 
Stages.add_sprite_info_array(0x0001, 0x0000, 0x0, 0x02)
// 
Stages.add_sprite_info_array(0x0001, 0x0001, 0x0, 0x01)
// 
Stages.add_sprite_info_array(0x0002, 0x0000, 0x0, 0x01)
// 
Stages.add_sprite_info_array(0x0003, 0x0000, 0x0, 0x01)
...
insert sprite_data, "dream_greens.bin"
