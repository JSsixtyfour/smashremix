...
constant NUM_SPRITE_INFO_ARRAYS(0x04)

// @ Description
// Not sure what the data is at this offset.
constant STAGE_FILE_OFFSET(0x000076A0)
...
//                           
Stages.add_sprite_info_array(0x0000, 0x0000, 0x1, 0x01)
//                           
