...
scope Resist {
    ...
    _resistance:
    lui t2, 0x3F60
    mtc1 t2, f4					// load the FP value of 0.875, which will give greater air resistance to link
    lui t2, 0x3F60
    mtc1 t2, f10				// load the FP value of 0.875, which will give greater air resistance to link
