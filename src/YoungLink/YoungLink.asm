...
scope YoungLink {
    ...
    Character.edit_action_parameters(YLINK, Action.CliffAttackQuick1,-1,                        EDGEATTACKF,                -1)
    Character.edit_action_parameters(YLINK, Action.CliffAttackQuick2,-1,                        EDGEATTACKF,                -1)
    Character.edit_action_parameters(YLINK, Action.CliffAttackSlow1, -1,                        EDGEATTACKS,                -1)
