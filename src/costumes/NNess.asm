scope polygon_ness_costumes {
    ...
    Costumes.define_part(1A, 1, Costumes.part_type.PALETTE)   // part 0x1A_0 - yoyo

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NNESS)
