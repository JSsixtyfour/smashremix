scope polygon_dedede_costumes {
    ...
    Costumes.define_part(E, 1, Costumes.part_type.PALETTE)    // part 0xD_0 - scythe
    ...
    Costumes.register_extra_costumes_for_char(Character.id.NDEDEDE)
