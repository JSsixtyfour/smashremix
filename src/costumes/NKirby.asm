scope polygon_kirby_costumes {
    ...
    Costumes.define_part(2, 2, Costumes.part_type.PALETTE)     // part 0x2_0 - body - face
    Costumes.define_part(6, 1, Costumes.part_type.PALETTE)     // part 0x6_0 - left arm
    Costumes.define_part(7, 1, Costumes.part_type.PALETTE)     // part 0xB_0 - left hand
    Costumes.define_part(B, 1, Costumes.part_type.PALETTE)     // part 0xC_0 - left arm
    Costumes.define_part(C, 1, Costumes.part_type.PALETTE)     // part 0x7_0 - left hand
    Costumes.define_part(14, 1, Costumes.part_type.PALETTE)    // part 0x14_0 - left foot
    Costumes.define_part(19, 1, Costumes.part_type.PALETTE)    // part 0x19_0 - right foot

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NKIRBY)
