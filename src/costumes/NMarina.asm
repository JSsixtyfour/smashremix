scope polygon_marina_costumes {
    ...
    Costumes.define_part(4, 1, Costumes.part_type.PALETTE)      // part 0x4_0 - left shoulder
    ...
    Costumes.define_part(B, 1, Costumes.part_type.PALETTE)      // part 0xB_0 - right shoulder
    Costumes.define_part(D, 1, Costumes.part_type.PALETTE)      // part 0xC_0 - right hand
    Costumes.define_part(11, 1, Costumes.part_type.PALETTE)     // part 0x10_0 - left upper leg
    Costumes.define_part(12, 1, Costumes.part_type.PALETTE)     // part 0x13_0 - left foot
    Costumes.define_part(16, 1, Costumes.part_type.PALETTE)     // part 0x15_0 - right upper leg
    Costumes.define_part(17, 1, Costumes.part_type.PALETTE)     // part 0x18_0 - right foot

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NMARINA)
