scope polygon_conker_costumes {
    ...
    Costumes.define_part(D, 1, Costumes.part_type.PALETTE)    // part 0xC_0 - weapons
    ...
    Costumes.define_part(18, 1, Costumes.part_type.PALETTE)   // part 0x18_0 - tail base
    Costumes.define_part(19, 1, Costumes.part_type.PALETTE)   // part 0x19_0 - tail tip

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NCONKER)
