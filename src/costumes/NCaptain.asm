scope polygon_captain_falcon_costumes {
    // @ Description
    ...
    Costumes.define_part(8, 1, Costumes.part_type.PALETTE)   // part 0x9_0 - head
    ...
    Costumes.register_extra_costumes_for_char(Character.id.NCAPTAIN)
