scope polygon_dk_costumes {
    ...
    Costumes.define_part(8, 1, Costumes.part_type.PALETTE)  // part 0x8_0 - head - hair
    ...
    Costumes.register_extra_costumes_for_char(Character.id.NDONKEY)
