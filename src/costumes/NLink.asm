scope polygon_link_costumes {
    ...
    Costumes.define_part(A, 1, Costumes.part_type.PALETTE)     // part 0xA_0 - right lower arm
    Costumes.define_part(B, 1, Costumes.part_type.PALETTE)     // part 0xB_0 - right hand
    Costumes.define_part(F, 1, Costumes.part_type.PALETTE)     // part 0xF_0 - shield
    Costumes.define_part(12, 1, Costumes.part_type.PALETTE)    // part 0x12_0 - neck
    ...
    Costumes.register_extra_costumes_for_char(Character.id.NLINK)
