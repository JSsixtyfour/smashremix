scope polygon_mewtwo_costumes {
    ...
    Costumes.define_part(C, 1, Costumes.part_type.PALETTE)      // part 0xC_0 - right upper arm
    Costumes.define_part(D, 1, Costumes.part_type.PALETTE)      // part 0xD_0 - right lower arm
    Costumes.define_part(E, 1, Costumes.part_type.PALETTE)      // part 0xE_0 - right hand
    Costumes.define_part(F, 1, Costumes.part_type.PALETTE)      // part 0xF_0 - tail 1
    Costumes.define_part(10, 1, Costumes.part_type.PALETTE)     // part 0x10_0 - tail 2
    Costumes.define_part(11, 1, Costumes.part_type.PALETTE)     // part 0x11_0 - tail 3
    Costumes.define_part(12, 1, Costumes.part_type.PALETTE)     // part 0x12_0 - tail 4
    Costumes.define_part(14, 1, Costumes.part_type.PALETTE)     // part 0x14_0 - left upper leg
    Costumes.define_part(15, 1, Costumes.part_type.PALETTE)     // part 0x15_0 - left lower leg
    Costumes.define_part(16, 1, Costumes.part_type.PALETTE)     // part 0x16_0 - left foot
    Costumes.define_part(1A, 1, Costumes.part_type.PALETTE)     // part 0x1A_0 - right upper leg
    Costumes.define_part(1B, 1, Costumes.part_type.PALETTE)     // part 0x1B_0 - right lower leg
    Costumes.define_part(1C, 1, Costumes.part_type.PALETTE)     // part 0x1C_0 - right foot

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NMTWO)
