scope polygon_banjo_costumes {
    ...
    Costumes.define_part(F, 1, Costumes.part_type.PALETTE)      // part 0xF_0 - right hand
    Costumes.define_part(10, 1, Costumes.part_type.PALETTE)     // part 0x10_0 - right hand
    Costumes.define_part(11, 1, Costumes.part_type.PALETTE)     // part 0x11_0 - right hand
    Costumes.define_part(12, 1, Costumes.part_type.PALETTE)     // part 0x12_0 - right hand
    Costumes.define_part(13, 1, Costumes.part_type.PALETTE)     // part 0x13_0 - right hand
    Costumes.define_part(14, 1, Costumes.part_type.PALETTE)     // part 0x14_0 - right hand
    Costumes.define_part(15, 1, Costumes.part_type.PALETTE)     // part 0x15_0 - right hand
    ...
    Costumes.define_part(20, 1, Costumes.part_type.PALETTE)     // part 0x20_0 - backpack

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NBANJO)
