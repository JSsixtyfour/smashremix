scope polygon_marth_costumes {
    ...
    Costumes.define_part(19, 1, Costumes.part_type.PALETTE)     // part 0x19_0 - left lower leg
    ...
    Costumes.register_extra_costumes_for_char(Character.id.NMARTH)
