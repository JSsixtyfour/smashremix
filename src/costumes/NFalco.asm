scope polygon_falco_costumes {
    ...
    Costumes.define_part(7, 1, Costumes.part_type.PALETTE)    // part 0x7_0 - neck
    ...
    Costumes.register_extra_costumes_for_char(Character.id.NFALCO)
